package net.prasenjit.myapp.web.rest;

import net.prasenjit.myapp.Application;
import net.prasenjit.myapp.domain.Authority;
import net.prasenjit.myapp.domain.User;
import net.prasenjit.myapp.repository.AuthorityRepository;
import net.prasenjit.myapp.repository.UserRepository;
import net.prasenjit.myapp.security.AuthoritiesConstants;
import net.prasenjit.myapp.service.MailService;
import net.prasenjit.myapp.service.UserService;
import net.prasenjit.myapp.web.rest.dto.UserDTO;
