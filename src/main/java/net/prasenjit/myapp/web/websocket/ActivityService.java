package net.prasenjit.myapp.web.websocket;

import net.prasenjit.myapp.security.SecurityUtils;
import net.prasenjit.myapp.web.websocket.dto.ActivityDTO;
...
import static net.prasenjit.myapp.config.WebsocketConfiguration.IP_ADDRESS;
